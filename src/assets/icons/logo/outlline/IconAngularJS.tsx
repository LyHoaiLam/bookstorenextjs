  ...
  >
    <defs>
      <linearGradient id="logosAngularIcon0" x1="25.071%" x2="96.132%" y1="90.929%" y2="55.184%">
        ...
        <stop offset="24%" stopColor="#F60A48"/><stop offset="35.2%" stopColor="#F20755" />
        <stop offset="49.4%" stopColor="#DC087D"/><stop offset="74.5%" stopColor="#9717E7" />
        <stop offset="100%" stopColor="#6C00F5"/>
      </linearGradient>
      <linearGradient id="logosAngularIcon1" x1="21.863%" x2="68.367%" y1="12.058%" y2="68.21%">
        <stop offset="0%" stopColor="#FF31D9"/><stop offset="100%" stopColor="#FF5BE1" stopOpacity="0" />
      </linearGradient>
    </defs>
