...
const IconNextJS = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        </defs><mask id="logosNextjsIcon3" fill="#fff">
                    <use href="#logosNextjsIcon2" />
                </mask><g mask="url(#logosNextjsIcon3)">
